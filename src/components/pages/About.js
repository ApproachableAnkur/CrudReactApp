...
const About = () => {
  return (
    ...
    <div className="py-4">
      <h1>Aboutpage</h1>
      <p>orem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus.
